...
if len( argv ) < 3:
    ...
    print "     -refinement  [for submission to refinement category"
...
REFINEMENT = parse_options( argv, "refinement", 0 )
...
for i in range( len( files ) ):
    ...
    if REFINEMENT:
        casp_file = 'TR%3s_%s.casp' % (target_num,i+1)
    else:
